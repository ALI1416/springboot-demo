...
- 继承父依赖不可修改版本号 :
  ...
  - `SpringBoot WebSocket` : `org.springframework.boot:spring-boot-starter-websocket`  
    ![Maven Central](https://img.shields.io/maven-central/v/org.springframework.boot/spring-boot-starter-websocket?label=Maven%20Central)
  ...
  - `自动装配` : `org.springframework.boot:spring-boot-autoconfigure-processor`  
    ![Maven Central](https://img.shields.io/maven-central/v/org.springframework.boot/spring-boot-autoconfigure-processor?label=Maven%20Central)
...
- 继承父依赖可修改版本号 :
  ...
  - `日志` : `ch.qos.logback:logback-classic`  
    ![Maven Central](https://img.shields.io/maven-central/v/ch.qos.logback/logback-classic?label=Maven%20Central)
