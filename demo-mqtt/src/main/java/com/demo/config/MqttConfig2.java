...
import com.demo.annotation.MqttCache;
...
public class MqttConfig2 {
    ...
    private static final Logger log = LoggerFactory.getLogger(MqttConfig2.class);
     ...
     */
    public MqttConfig2(MqttProperties mqttProperties, MqttCache mqttCache) {
    ...
    public MqttClient client() throws MqttException {
        ...
        client.setCallback(new MqttCallbackExtended() {
            ...
            public void connectComplete(boolean reconnect, String uri) {
                ...
                try {
                    client.subscribeWithResponse(mqttCache.getTopicArray(), mqttCache.getQosArray(), mqttCache.getCallbackArray());
